abstract final class ApiEndpoints {
  ...
  static const adminSubAdminPermissions =
      '/api/v1/admin/sub-admins/permissions';
  static String adminSubAdmin(String id) => '/api/v1/admin/sub-admins/$id';
  static String adminSubAdminHistory(String id) =>
      '/api/v1/admin/sub-admins/$id/history';
  static String adminStudent(String id) => '/api/v1/admin/students/$id';
  static String adminStudentHistory(String id) =>
      '/api/v1/admin/students/$id/history';
  static String adminStudentMentor(String id) =>
  ...
  static String adminTeacherHistory(String id) =>
      '/api/v1/admin/teachers/$id/history';
  static String adminTeacherPromotedStudents(String id) =>
      '/api/v1/admin/teachers/$id/promoted-students';
  static const adminBatches = '/api/v1/admin/batches';
  static String adminBatch(String id) => '/api/v1/admin/batches/$id';
  static String adminBatchStatus(String id) =>
      '/api/v1/admin/batches/$id/status';
  static String adminBatchStudents(String id) =>
      '/api/v1/admin/batches/$id/students';
  ...
  static String adminLevelBatches(String levelId) =>
      '/api/v1/admin/levels/$levelId/batches';
  static String adminLevelTeachers(String levelId) =>
      '/api/v1/admin/levels/$levelId/teachers';
  ...
  static String adminStudentLearningWeek(
    String studentId,
    String journeyId,
    int week,
  ) => '/api/v1/admin/students/$studentId/learning-journal/$journeyId/$week';
  static String adminStudentPromote(String studentId) =>
      '/api/v1/admin/students/$studentId/promote';
  ...
  static String masterTeacherStudentLearningWeek(
    String studentId,
    String journeyId,
    int week,
  ) =>
  ...
  static String teacherBatchAssessments(String batchId) =>
      '/api/v1/teacher/batches/$batchId/assessments';
  ...
  static String adminAssessmentActivate(String id) =>
      '/api/v1/admin/assessments/$id/activate';
  static String adminAssessmentDeactivate(String id) =>
      '/api/v1/admin/assessments/$id/deactivate';
  static String adminAssessmentAttempts(String id) =>
      '/api/v1/admin/assessments/$id/attempts';
  static String adminStudentResults(String id) =>
      '/api/v1/admin/students/$id/results';
  static String adminStudentFeedback(String id) =>
      '/api/v1/admin/students/$id/feedback';
  ...
  static String adminStudentFeedbackSummary(String id) =>
      '/api/v1/admin/students/$id/feedback/summary';
  ...
  static String masterTeacherFeedback(String studentId) =>
      '/api/v1/master-teacher/students/$studentId/feedback';
  static String masterTeacherFeedbackSummary(String studentId) =>
      '/api/v1/master-teacher/students/$studentId/feedback/summary';
  static String masterTeacherFeedbackItem(
    String studentId,
    String feedbackId,
  ...
  static String teacherStudentResults(String studentId) =>
      '/api/v1/teacher/students/$studentId/results';
  static String teacherStudent(String studentId) =>
      '/api/v1/teacher/students/$studentId';
  static String teacherStudentFeedback(String studentId) =>
      '/api/v1/teacher/students/$studentId/feedback';
  ...
  static String teacherStudentLearningWeek(
    String studentId,
    String journeyId,
    int week,
  ...
  static String adminRequestResolve(String id) =>
      '/api/v1/admin/requests/$id/resolve';
  ...
  static String teacherScheduleLeave(String id) =>
      '/api/v1/teacher/schedule/leaves/$id';

  static const studentBookings = '/api/v1/student/bookings';
  static const studentBookingEligibility =
      '/api/v1/student/bookings/eligibility';
  static const studentBookingTeachers = '/api/v1/student/bookings/teachers';
  static String studentBookingTeacher(String teacherId) =>
      '/api/v1/student/bookings/teachers/$teacherId';
  static const studentBookingAvailability =
      '/api/v1/student/bookings/availability';
  static String studentBooking(String id) => '/api/v1/student/bookings/$id';
  static String studentBookingJoin(String id) =>
      '/api/v1/student/bookings/$id/join';
  static String studentBookingAttendanceReport(String id) =>
      '/api/v1/student/bookings/$id/attendance-reports';
  static String teacherBookingJoin(String id) =>
      '/api/v1/teacher/schedule/bookings/$id/join';
  static String teacherBookingAttendanceReport(String id) =>
      '/api/v1/teacher/schedule/bookings/$id/attendance-reports';
  static String teacherBookingWhatsApp(String id) =>
      '/api/v1/teacher/schedule/bookings/$id/whatsapp';
  static const adminAttendance = '/api/v1/admin/attendance';
  static String adminAttendanceItem(String id) =>
      '/api/v1/admin/attendance/$id';
  static String adminAttendanceResolve(String id) =>
      '/api/v1/admin/attendance/$id/resolve';
  ...
  static String adminTeacherAvailabilityOverride(
    String teacherId,
    String overrideId,
  ) =>
      '/api/v1/admin/schedule/teachers/$teacherId/availability/overrides/$overrideId';
  static String adminTeacherBreaks(String teacherId) =>
