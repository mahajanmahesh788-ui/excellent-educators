...
class StoreStudentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'career_compass_level_id' => ['required_without:class_grade', 'nullable', 'ulid', 'exists:career_compass_levels,id'],
            'class_grade' => ['required_without:career_compass_level_id', 'nullable', 'integer', 'min:5', 'max:12'],
